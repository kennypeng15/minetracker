export default function MovingAverage(dataList, windowSize) {
  ...
  while (i < dataList.length) {
    currentTimeWindow =
      currentTimeWindow +
      dataList[i]["effectiveTime"] -
      dataList[i - windowSize]["effectiveTime"];
    currentEffWindow =
      currentEffWindow +
      dataList[i]["efficiency"] -
      dataList[i - windowSize]["efficiency"];
    current3bvpsWindow =
      current3bvpsWindow +
      dataList[i]["game-3bvps"] -
      dataList[i - windowSize]["game-3bvps"];
